...
public class AIAgent21730745 implements Agent{
	private String name;
	private String players;
	private boolean spy;
	private int missionNum, failuresNum;
	private String spies;
	private String nominatedTeam;
	
	public AIAgent21730745(){
		ISMCTS21730745 nominate = new ISMCTS21730745();		
	}
  ...
  public String do_Nominate(int number){
	State21730745 currentState = new State21730745(name, players, spies, missionNum, failuresNum, Phase21730745.Nominate);
	Action21730745 action = ISMCTS21730745.run(currentState,spy);
  ...
  public boolean do_Vote(){
		State21730745 currentState = new State21730745(name, players, spies, missionNum, failuresNum, Phase21730745.Vote);
		currentState.nominatedTeam = nominatedTeam;
		String action = ISMCTS21730745.run(currentState,spy).getAction();
  ...
  public boolean do_Betray(){
	if (!spy) {
		...
		State21730745 currentState = new State21730745(name, players, spies, missionNum, failuresNum, Phase21730745.Betray);
			String action = ISMCTS21730745.run(currentState,spy).getAction();
		if (action == "yes") {
			return true;
		}
